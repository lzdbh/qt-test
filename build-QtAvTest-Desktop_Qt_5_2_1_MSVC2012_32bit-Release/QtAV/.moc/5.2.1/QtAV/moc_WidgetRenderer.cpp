...
#include "../../../../../QtAvTest/QtAV/src/QtAV/WidgetRenderer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtAV__WidgetRenderer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0)
    ...
    "QtAV::WidgetRenderer\0imageReady\0\0"
};
...
void QtAV::WidgetRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WidgetRenderer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WidgetRenderer::imageReady)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QtAV::WidgetRenderer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QtAV__WidgetRenderer.data,
      qt_meta_data_QtAV__WidgetRenderer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__WidgetRenderer.stringdata))
        return static_cast<void*>(const_cast< WidgetRenderer*>(this));
    if (!strcmp(_clname, "QPainterRenderer"))
        return static_cast< QPainterRenderer*>(const_cast< WidgetRenderer*>(this));
