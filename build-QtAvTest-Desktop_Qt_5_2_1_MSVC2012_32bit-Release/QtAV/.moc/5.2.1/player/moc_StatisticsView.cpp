...
#include "../../../../../QtAvTest/QtAV/examples/player/StatisticsView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StatisticsView_t, stringdata) + ofs \
...
const QMetaObject StatisticsView::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StatisticsView.data,
      qt_meta_data_StatisticsView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StatisticsView.stringdata))
