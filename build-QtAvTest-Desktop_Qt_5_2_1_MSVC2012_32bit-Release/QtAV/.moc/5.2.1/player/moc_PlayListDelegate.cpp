...
#include "../../../../../QtAvTest/QtAV/examples/player/playlist/PlayListDelegate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PlayListDelegate_t, stringdata) + ofs \
...
const QMetaObject PlayListDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_PlayListDelegate.data,
      qt_meta_data_PlayListDelegate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlayListDelegate.stringdata))
