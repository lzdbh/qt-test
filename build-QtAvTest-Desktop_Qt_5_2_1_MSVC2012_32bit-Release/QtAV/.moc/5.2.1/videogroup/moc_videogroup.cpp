...
#include "../../../../../QtAvTest/QtAV/examples/videogroup/videogroup.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoGroup_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 92, 14)
    ...
    "openLocalFile\0addRenderer\0removeRenderer\0"
};
...
const QMetaObject VideoGroup::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoGroup.data,
      qt_meta_data_VideoGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoGroup.stringdata))
