...
#include "../../../../../QtAvTest/QtAV/examples/player/ClickableMenu.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ClickableMenu_t, stringdata) + ofs \
...
const QMetaObject ClickableMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_ClickableMenu.data,
      qt_meta_data_ClickableMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ClickableMenu.stringdata))
