...
#include "../../../../../QtAvTest/QtAV/src/QtAV/AVDemuxThread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtAV__AVDemuxThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 34, 9)
    ...
    "QtAV::AVDemuxThread\0stop\0\0pause\0p\0"
    "notifyEnd\0"
};
...
const QMetaObject QtAV::AVDemuxThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QtAV__AVDemuxThread.data,
      qt_meta_data_QtAV__AVDemuxThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__AVDemuxThread.stringdata))
