...
#include "../../../../../QtAvTest/QtAV/src/QtAV/AudioThread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtAV__AudioThread_t, stringdata) + ofs \
...
const QMetaObject QtAV::AudioThread::staticMetaObject = {
    { &AVThread::staticMetaObject, qt_meta_stringdata_QtAV__AudioThread.data,
      qt_meta_data_QtAV__AudioThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__AudioThread.stringdata))
