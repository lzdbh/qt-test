...
#include "../../../../../QtAvTest/QtAV/examples/videowall/VideoWall.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoWall_t, stringdata) + ofs \
...
const QMetaObject VideoWall::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoWall.data,
      qt_meta_data_VideoWall,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoWall.stringdata))
